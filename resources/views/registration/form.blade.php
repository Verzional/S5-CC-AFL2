    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8 border-t-4 border-indigo-600">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Lengkapi formulir di bawah untuk mendaftar</p>
            </div>
            ...
            <p class="mt-6 text-sm text-gray-500 text-center">
                Sudah punya akun? <a href="#" class="text-indigo-600 hover:underline font-semibold">Masuk di
                    sini</a>
            </p>
        </div>
    </div>
